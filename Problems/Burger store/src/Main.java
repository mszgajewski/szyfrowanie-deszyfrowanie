class TestDrive {
    public static void main(String[] args) throws InterruptedException {
        final BurgerFactory burgerFactory = new BurgerStore();
...
class BurgerStore extends BurgerFactory {
    ...
    Burger createBurger(String type) {
        switch (type) {
            case "Chinese":
                return new ChineseBurger(type + " Burger");
            case "American":
                return new AmericanBurger(type + " Burger");
            case "Russian":
                return new RussianBurger(type + " Burger");
            default:
                return null;
        }
    }
